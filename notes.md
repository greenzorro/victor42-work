...
| 参数 | 默认值 | 作用 |
|------|--------|------|
| `shadowColor` | `#314039` | 树影颜色 |
| `shadowOpacity` | `0.12` | 最终统一着色透明度 |
| `windStrength` | `1.13` | 复合风力倍率，只改变受风偏转强度 |
